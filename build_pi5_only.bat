...
set FULL_CFLAGS=-Wall -Wextra -ffreestanding -nostdlib -nostartfiles -std=gnu11 -march=armv8.2-a+simd+crc+crypto -Iinclude -O2 -fstack-protector-strong -DPIOS_EMBED_RAW_IDE_ASSETS
set ASFLAGS=-march=armv8.2-a+simd+crc+crypto -DPIOS_EMBED_RAW_IDE_ASSETS
