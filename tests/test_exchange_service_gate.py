#!/usr/bin/env python3
"""Static guard for discovery-only p3 exchange boot attachment."""
...
assert "backend.write" not in init, "boot attachment must never write p3"
...
print("exchange service gate: discovery-only p3 attachment")
