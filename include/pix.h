/*
 * pix.h - PIX executable format and module loader
 *
 * Defines the PIX binary format for loadable executables and kernel
...
#define PIX_MAGIC       0x50495821  /* 'PIX!' */
#define PIX_VERSION     1

/* Binary types */
#define PIX_EXEC        1
#define PIX_MODULE      2
#define PIX_LIBRARY     3

/* Header flags */
#define PIX_RELOCATABLE 0x01
#define PIX_NEEDS_NEON  0x02
...
/* Load a PIX executable into memory at base. Returns entry point or 0. */
