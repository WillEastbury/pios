...
echo Building shared Pi5+QEMU stage2 package...
...
copy /Y real_kernel.img build_uefi\PIOSSTG2.PKG >nul
if errorlevel 1 exit /b 1
...
for %%f in (build_uefi\PIOSSTG2.PKG) do echo shared PIOSSTG2.PKG size: %%~zf bytes
